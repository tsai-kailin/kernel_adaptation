...
#generate data
#code available here: https://github.com/Afsaneh-Mastouri/KPV/blob/master/Experiments/SyntheticExperiment/GenerativeFunction.py
...
def gen_C(U1,U2,X1,X2, beta, n, key):
    C= X1*random.normal(key,(n,)) * beta+ X2
    return C



def gen_C(U1,U2,X1,X2, beta, n, key):
    C= X1*random.normal(key,(n,)) * beta
    return C
"""
#def gen_C(U1,U2,X1,X2, beta, n, key):
    #work dgp2#
