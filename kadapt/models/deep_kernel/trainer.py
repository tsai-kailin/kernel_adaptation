...
from kadapt.data.data_class import  split_train_data, dfaDataSetTorch
    ...
    def train(self, source_traindata, target_traindata, split, verbose, PLOT=True):
        ...
        if split:
            ...
            for t in range(self.n_epoch):
                ...
                self.cme_wc_x_feature_update(source_traindata, tartget_traindata, verbose)
    ...
    def train(self, source_traindata, target_traindata, split, verbose, PLOT=True):
        ...
        if split:
            ...
            for t in range(self.n_epoch):
                self.cme_w_xc_feature_update(source_traindata, verbose)
                self.h0_feature_update(source_traindata, source_traindata, verbose)
                self.cme_w_x_feature_update(source_traindata, tartget_traindata, verbose)
